...
<!--
	...
	function saveData(){
		...
		document.form1.action = "${pageContext.request.contextPath}/auth/updateOrganAuthAdmin";
	...
	function loadData(){
		...
		document.form1.action = "${pageContext.request.contextPath}/auth/showOrganAuthAdmin";
		document.form1.submit();
	}
