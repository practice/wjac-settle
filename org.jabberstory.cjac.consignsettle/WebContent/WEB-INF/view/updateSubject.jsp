		...
		<table width="100%" cellspacing="0">
			<tbody>
				<tr>
					...
					<td class="cell"><input type="text" name="govContributeAmount" value="${organ.govContributeAmount}"  style="" title="정부출연금" class="line_box" style="width:150px" onblur="checkMoney('govContributeAmount');return false;">원</td>
