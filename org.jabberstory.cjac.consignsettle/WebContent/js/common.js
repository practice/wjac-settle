/*--------------------------------------------------------------------------------*\
	...
	\*--------------------------------------------------------------------------------*/
	  ...
	  //-----------------------------------------------------------------------------
	    ...
	    String.prototype.numwithdecimal = function() {

	    	return (/(^[0-9]{1,3})+(\.[0-9]{1,2})?$/g).test(this.trim());
	    ...
	    String.prototype.meta = function() {
	        ...
	        for(var i = 0; i < str.length; i++) {
	            ...
	            if((/([\$\(\)\*\+\.\[\]\?\\\^\{\}\|]{1})/).test(str.charAt(i))) {
	                ...
	                result += str.charAt(i).replace((/([\$\(\)\*\+\.\[\]\?\\\^\{\}\|]{1})/), "<a target='_blank' class='con_link'  href='file://$1/' >\\$1</A>");
