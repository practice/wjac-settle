...
public class DataAdminMultiActionController extends MultiActionController {
	...
	public DataAdminMultiActionController() {}	

	public ModelAndView showDataAdmin(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ModelAndView mv = new ModelAndView("dataAdmin");
	...
	public ModelAndView updateDataAdmin(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String selectedGroupId = request.getParameter("selectedGroupId");
